 ...
 * bookmarkable pages.<br />The historyToken is decomposed into action and params.<br />
...
public class BrowserEvent {
	...
	private static final char URL_PARAMS_EQUAL = '=';
	...
	private Map<String, String> toMap(String params) {
		...
		for (String param : paramsarray) {
			paramsMap.put(param.substring(0, param.indexOf(URL_PARAMS_EQUAL)), param.substring(param.indexOf('=') + 1));
		}
		return paramsMap;
	}
