...
public class PocViewNumericWithVisibleMasker extends View<Integer, VerticalPanel> {

	public static final String ID = "visibleMasker";
	...
	protected void plusAction() {
		controller.call(new Event<Integer, PocAction>(PocAction.DO_PLUS_A, component.getValue(), PocVisibleMasker.getInstance()));
	}

	protected void minusAction() {
		controller.call(new Event<Integer, PocAction>(PocAction.DO_MINUS_A, component.getValue(), PocVisibleMasker.getInstance()));
	}

	protected void reinitAction() {
		controller.call(new Event<Integer, PocAction>(PocAction.DO_REINIT_A, 0, PocVisibleMasker.getInstance()));
	}
