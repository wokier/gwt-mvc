...
public class PocViewNumericWithVisibleMasker extends View<Integer, VerticalPanel> {
	...
	protected void plusAction() {
		controller.call(new MvcEvent<Integer>(PocAction.DO_PLUS_A, component.getValue(), PocVisibleMasker.getInstance()));
	}

	protected void minusAction() {
		controller.call(new MvcEvent<Integer>(PocAction.DO_MINUS_A, component.getValue(), PocVisibleMasker.getInstance()));
	}

	protected void reinitAction() {
		controller.call(new MvcEvent<Integer>(PocAction.DO_REINIT_A, 0, PocVisibleMasker.getInstance()));
	}
