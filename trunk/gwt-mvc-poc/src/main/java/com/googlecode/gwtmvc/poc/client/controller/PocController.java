...
import com.googlecode.gwtmvc.poc.client.view.htmlbinder.PocViewHtmlBinder;
...
public class PocController extends PocBrowsableController {
	...
	SHOW_SIMPLE, SHOW_COMPLEX, SHOW_MASKABLE, SHOW_STYLE_MASKER, SHOW_VISIBLE_MASKER, DO_PLUS_A, DO_MINUS_A, DO_REINIT_A, DO_PLUS_B, DO_MINUS_B, DO_REINIT_B, SHOW_URLPARAMS, SHOW_EXCEPTION, DO_CHECKED_EXCEPTION, DO_UNCHECKED_EXCEPTION, SHOW_UIBINDER, SHOW_UIBINDER_HTML
    }
    ...
    protected IView pocViewHtmlBinder;
	...
	case DO_UNCHECKED_EXCEPTION:
	    ...
	    break;
	case SHOW_UIBINDER:
	    // lazy loading must be done here with UIBinder, not in the init
	    if (pocViewUIBinder == null) {
		pocViewUIBinder = new PocViewUIBinder(this, modelA);
	    }
	    content.clearAndAdd(pocViewUIBinder);
	    break;
	case SHOW_UIBINDER_HTML:
	    if (pocViewHtmlBinder == null) {
		pocViewHtmlBinder = new PocViewHtmlBinder(this, modelA);
	    }
	    content.clearAndAdd(pocViewHtmlBinder);
	    break;
	default:
